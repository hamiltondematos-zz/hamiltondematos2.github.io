...
var subjects = [
    ...
    {name: "RCP", desc: "Situacoes em que voce nao recomendaria"},
    {name: "RCP", desc: "Sistema de janelas"},
    {name: "RCP", desc: "Ajuda de contexto"},
    {name: "RCP", desc: "i18n"},
    {name: "RCP", desc: "GUI Builder"},
    {name: "Servlets", desc: "Funcionamento, aplicacoes"},
    {name: "Servlets", desc: "Situacoes em que voce nao recomendaria"},    
    {name: "Websockets", desc: "Exemplos de utilizacao/funcionamento (alem de gmail, leiloes e teclado virtual)"},
    {name: "Websockets", desc: "Situacoes em que voce nao recomendaria"},    
    ...
    {name: "JSF", desc: "Situacoes em que voce nao recomendaria"},        
